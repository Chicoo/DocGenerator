...
namespace AODL.Document.Forms
{
	...
	public class SingleFormProperty: FormProperty
	{
		...
		public string Value
		{
			get
			{
				...
				XmlNode xn = _node.SelectSingleNode("@office:"+s, 
					_document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@office:"+s, 
				_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute(s, "office"));
		...
		public override string Name
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:property-name", 
			...
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:property-name", 
					Document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(Document.CreateAttribute("property-name", "form"));
				nd.InnerText = value;
			}
		}
	...
	public class ListFormPropertyElement
	{
		...
		public class ListFormProperty: FormProperty
		{
			...
			{
				Node.AppendChild((value as ListFormPropertyElement).Node);
			}

			private void PropertyValuesCollection_Removed(int index, object value)
			{
				Node.RemoveChild((value as ListFormPropertyElement).Node);
			}
		}
		#endregion
}
