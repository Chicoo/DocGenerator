...
namespace AODL.Document.Forms.Controls
{
	public class ODFComboBox: ODFFormControl
	{
		...
		public XmlBoolean Disabled
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:disabled", 
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:disabled", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("disabled", "form"));
				nd.InnerText = s;
			}
		}
		...
		public XmlBoolean AutoComplete
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:auto-complete", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:auto-complete", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("auto-complete", "form"));
				nd.InnerText = s;
			}
		}
		...
		public string Title
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:title", 
					_document.NamespaceManager);
			...
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:title", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("title", "form"));
				nd.InnerText = value;
			}
		}
		...
		public string ListSource
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:list-source", 
					_document.NamespaceManager);
				if (xn == null) return null;
				return xn.InnerText;
			}
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:list-source", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("list-source", "form"));
				nd.InnerText = value;
			}
		}
		...
		public string DataField
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:data-field", 
					_document.NamespaceManager);
				if (xn == null) return null;
				return xn.InnerText;
			}
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:data-field", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("title", "form"));
				nd.InnerText = value;
		...
		{	
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:list-source-type", 
					_document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:list-source-type", 
					_document.NamespaceManager);
				if (nd == null)
					nd = _node.Attributes.Append(_document.CreateAttribute("list-source-type", "form"));
				nd.InnerText = s;
			}
		}
		...
		public int TabIndex
		{
			get
			{
				return int.Parse(_node.SelectSingleNode("@form:tab-index", 
					_document.NamespaceManager).InnerText);
			}
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:tab-index", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("tab-index", "form"));
		...
		public XmlBoolean TabStop
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:tab-stop", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:tab-stop", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("tab-stop", "form"));
				nd.InnerText = s;
			}
		}
		...
		public XmlBoolean Printable
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:printable", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:printable", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("printable", "form"));
				nd.InnerText = s;
			}
		}
		...
		public XmlBoolean ReadOnly
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:readonly", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:readonly", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("readonly", "form"));
				nd.InnerText = s;
			}
		}
		...
		public XmlBoolean DropDown
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:dropdown", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:dropdown", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("dropdown", "form"));
				nd.InnerText = s;
			}
		}
		...
		public int Size
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:size", 
					_document.NamespaceManager);
				if (xn == null) return -1;
			...
			set
			{
				if (value >0)
				{
					XmlNode nd = _node.SelectSingleNode("@form:size", 
						_document.NamespaceManager);
					if (nd == null)
						nd = Node.Attributes.Append(_document.CreateAttribute("size", "form"));
					nd.InnerText = value.ToString();
				}
				else
				{
		...
		public XmlBoolean ConvertEmptyToNull
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:convert-empty-to-null", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:convert-empty-to-null", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("convert-empty-to-null", "form"));
				nd.InnerText = s;
			}
		}
		...
		public string CurrentValue
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:current-value", 
					_document.NamespaceManager);
				if (xn == null) return null;
				return xn.InnerText; 
			}
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:current-value", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("current-value", "form"));
				nd.InnerText = value;
			}
		}
		...
		public int MaxLength
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:max-length", 
					_document.NamespaceManager);
				if (xn == null) return -1;
				return int.Parse(xn.InnerText);
			}
			set
			{
				if (value >0)
				{
					XmlNode nd = _node.SelectSingleNode("@form:max-length", 
						_document.NamespaceManager);
					if (nd == null)
						nd = Node.Attributes.Append(_document.CreateAttribute("max-length", "form"));
					nd.InnerText = value.ToString();
				}
				else
				{
		...
		public string Value
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:value", 
					_document.NamespaceManager);
				if (xn == null) return null;
				return xn.InnerText;
			}
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:value", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("value", "form"));
				nd.InnerText = value;
			}
		}
		/// <summary>
		...
		{
			XmlNode xe = _document.CreateNode("combobox", "form");
			Node.AppendChild(xe);
			Node = xe;
