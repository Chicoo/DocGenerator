...
namespace AODL.Document.Forms.Controls
{
	public class ODFFixedText: ODFFormControl
	{
		...
		public string For
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:for", 
					_document.NamespaceManager);
			...
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:for", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("for", "form"));
				nd.InnerText = value;
			}
		}
		...
		public XmlBoolean MultiLine
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:multi-line", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:multi-line", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("multi-line", "form"));
				nd.InnerText = s;
			}
		}
		...
		public string Label
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:label", 
					_document.NamespaceManager);
				if (xn == null) return null;
				return xn.InnerText;
			}
		...
		{
			XmlNode xe = _document.CreateNode("fixed-text", "form");
			Node.AppendChild(xe);
			Node = xe;
