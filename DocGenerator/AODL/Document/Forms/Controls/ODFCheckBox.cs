...
namespace AODL.Document.Forms.Controls
{
	public class ODFCheckBox: ODFFormControl
	{
		...
		public string Label
		{
			...
			{
				XmlNode xn;
				xn = _node.SelectSingleNode("@form:label", 
					_document.NamespaceManager);
				if (xn == null) return null;
				return xn.InnerText;
			}
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:label", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("label", "form"));
				nd.InnerText = value;
			}
		}
		...
		public XmlBoolean IsTristate
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:is-tristate", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:is-tristate", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("is-tristate", "form"));
				nd.InnerText = s;
			}
		}
		...
		{	
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:visual-effect", 
					_document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:visual-effect", 
					_document.NamespaceManager);
				if (nd == null)
					nd = _node.Attributes.Append(_document.CreateAttribute("visual-effect", "form"));
				nd.InnerText = s;
			}
		}
		...
		{	
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:image-position", 
					_document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:image-position", 
					_document.NamespaceManager);
				if (nd == null)
					nd = _node.Attributes.Append(_document.CreateAttribute("image-position", "form"));
				nd.InnerText = s;
			}
		}
		...
		{	
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:image-align", 
					_document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:image-align", 
					_document.NamespaceManager);
				if (nd == null)
					nd = _node.Attributes.Append(_document.CreateAttribute("image-align", "form"));
				nd.InnerText = s;
			}
		}
		...
		{	
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:state", 
					_document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:state", 
					_document.NamespaceManager);
				if (nd == null)
					nd = _node.Attributes.Append(_document.CreateAttribute("state", "form"));
				nd.InnerText = s;
			}
		}
		...
		{	
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:current-state", 
					_document.NamespaceManager);
				if (xn == null) return State.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:current-state", 
					_document.NamespaceManager);
				if (nd == null)
					nd = _node.Attributes.Append(_document.CreateAttribute("current-state", "form"));
				nd.InnerText = s;
			}
		}
		...
		{
			XmlNode xe = _document.CreateNode("checkbox", "form");
			Node.AppendChild(xe);
			Node = xe;
			ControlImplementation = "ooo:com.sun.star.form.component.CheckBox";
		}
	}
}
