...
namespace AODL.Document.Forms.Controls
{
	public class ODFRadioButton: ODFFormControl
	{
		...
		public XmlBoolean Selected
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:selected", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:selected", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("selected", "form"));
				nd.InnerText = s;
			}
		}
		...
		public XmlBoolean CurrentSelected
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:current-selected", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:current-selected", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("current-selected", "form"));
				nd.InnerText = s;
			}
		}
		...
		{
			XmlNode xe = _document.CreateNode("radio", "form");
			Node.AppendChild(xe);
			Node = xe;
