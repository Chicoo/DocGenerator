...
namespace AODL.Document.Forms.Controls
{
	public class ODFButton: ODFFormControl
	{
		...
		public string ImageData
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:image-data", 
					_document.NamespaceManager);
				if (xn == null) return null;
				return xn.InnerText;
			}
			set
			{
				XmlNode nd = _node.SelectSingleNode("@form:image-data", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("image-data", "form"));
				nd.InnerText = value;
			}
		}
		...
		public XmlBoolean Toggle
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:toggle", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:toggle", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("toggle", "form"));
				nd.InnerText = s;
			}
		}
		...
		public XmlBoolean DefaultButton
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:default-button", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:default-button", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("default-button", "form"));
				nd.InnerText = s;
			}
		}
		...
		public XmlBoolean FocusOnClick
		{
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:focus-on-click", 
					_document.NamespaceManager);
				if (xn == null) return XmlBoolean.NotSet;
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:focus-on-click", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("focus-on-click", "form"));
				nd.InnerText = s;
			}
		}
		...
		{	
			get
			{
				XmlNode xn = _node.SelectSingleNode("@form:button-type", 
					_document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@form:button-type", 
					_document.NamespaceManager);
				if (nd == null)
					nd = _node.Attributes.Append(_document.CreateAttribute("button-type", "form"));
				nd.InnerText = s;
			}
		}
		...
		{	
			...
			set
			{
				...
				XmlNode nd = _node.SelectSingleNode("@office:target-frame", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("target-frame", "office"));
				nd.InnerText = s;
			}
		}
		...
		public string TargetLocation
		{
			...
			set
			{
				XmlNode nd = _node.SelectSingleNode("@xlink:href", 
					_document.NamespaceManager);
				if (nd == null)
					nd = Node.Attributes.Append(_document.CreateAttribute("href", "xlink"));
				nd.InnerText = value;
			}
		}
		/// <summary>
		...
		{
			XmlNode xe = _document.CreateNode("button", "form");
			Node.AppendChild(xe);
			Node = xe;
