...
namespace AODL.Document.Styles
{
	...
	public class TabStopStyleCollection : CollectionWithEvents<TabStopStyle>
	{
		...
		{
			Document		= document;
			Node			= Document.CreateNode("tab-stops", "style");
		}
		...
		/// <returns></returns>
		public new TabStopStyleCollection Add(TabStopStyle value)
		{
			Node.AppendChild(((TabStopStyle)value).Node);
			base.Add(value);
			return this;
		}
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public new void Remove(TabStopStyle value)
		{
			Node.RemoveChild(((TabStopStyle)value).Node);
			base.Remove(value);
		}
		...
		/// <param name="value">The value.</param>
		public new void Insert(int index, TabStopStyle value)
		{
