...
namespace AODL.Document.Styles.MasterStyles
{
	...
	public class TextMasterPageCollection : CollectionWithEvents<TextMasterPage>
	{
		...
		public TextMasterPage GetByStyleName(string styleName)
		{
			foreach(TextMasterPage txtMP in this)
			{
		...
		public TextMasterPage GetDefaultMasterPage()
		{
			return GetByStyleName("Standard");
		}
	}
}
