	...
	public class FrameStyle : AbstractStyle
	{
		...
		public GraphicProperties GraphicProperties
		{
			get
			{
				...
				PropertyCollection.Add((IProperty)graphicProperties);
		...
		public FrameStyle(IDocument document, string styleName)
		{
			...
			NewXmlNode();
			StyleName				= styleName;
			GraphicProperties		= new GraphicProperties((IStyle)this);
		}
...
//			this.Document.Styles.Add((IStyle)this);
		...
		{			
			...
			XmlAttribute xa	= Document.CreateAttribute("family", "style");
