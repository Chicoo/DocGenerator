...
namespace AODL.Document.Styles.Properties
{
	...
	public class ColumnProperties : IProperty
	{
		...
		public string Width
		{
			get 
			{	
				return (_node.Attributes["style:column-width"]!=null) ? _node.Attributes["style:column-width"].Value : String.Empty;
			}
			set
			{
				if (_node.Attributes["style:column-width"]!=null)
					_node.Attributes["style:column-width"].Value=value;
				else 
					CreateAttribute("column-width", value, "style");
			}
		}
		...
		public string RelativeWidth
		{
			get 
			{ 
				XmlNode xn = _node.SelectSingleNode("@style:rel-column-width",
			...
			set
			{
				XmlNode xn = _node.SelectSingleNode("@style:rel-column-width",
					Style.Document.NamespaceManager);
				if (xn == null)
					CreateAttribute("rel-column-width", value, "style");
				_node.SelectSingleNode("@style:rel-column-width",
		...
		{
			Node		= Style.Document.CreateNode("table-column-properties", "style");
		}
