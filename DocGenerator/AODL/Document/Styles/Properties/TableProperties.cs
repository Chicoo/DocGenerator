...
namespace AODL.Document.Styles.Properties
{
	...
	public class TableProperties : IProperty, IHtmlStyle
	{
		...
		public string Width
		{
			get 
			{ 
				XmlNode xn = _node.SelectSingleNode("@style:width",
			...
			set
			{
				XmlNode xn = _node.SelectSingleNode("@style:width",
					Style.Document.NamespaceManager);
				if (xn == null)
					CreateAttribute("width", value, "style");
				_node.SelectSingleNode("@style:width",
		...
		public string Align
		{
			get 
			{ 
				XmlNode xn = _node.SelectSingleNode("@table:align",
					Style.Document.NamespaceManager);
				if (xn != null)
					return xn.InnerText;
				return null;
			...
			set
			{
				XmlNode xn = _node.SelectSingleNode("@table:align",
					Style.Document.NamespaceManager);
				if (xn == null)
					CreateAttribute("align", value, "table");
				_node.SelectSingleNode("@table:align",
					Style.Document.NamespaceManager).InnerText = value;
			}
		}
		...
		public string Shadow
		{
			get 
			{ 
				XmlNode xn = _node.SelectSingleNode("@style:shadow",
					Style.Document.NamespaceManager);
				if (xn != null)
					return xn.InnerText;
				return null;
			...
			set
			{
				XmlNode xn = _node.SelectSingleNode("@style:shadow",
					Style.Document.NamespaceManager);
				if (xn == null)
					CreateAttribute("shadow", value, "style");
				_node.SelectSingleNode("@style:shadow",
					Style.Document.NamespaceManager).InnerText = value;
			}
		}
		...
		private void NewXmlNode()
		{
            ...
            XmlNode node = document.CreateNode("table-properties", "style");
			Node		= node;
