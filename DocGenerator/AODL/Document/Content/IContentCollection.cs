...
namespace AODL.Document.Content
{
	...
	public class ContentCollection : CollectionWithEvents<IContent>
	{
		...
		/// <returns></returns>
		public override CollectionWithEvents<IContent> Add(IContent value)
		{
			if (value is Field)
			{
                if (value is Field f)
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public new void Remove(IContent value)
		{
			if (value is Field)
			{
                if (value is Field f)
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public void RemoveOnlyHere(IContent value)
		{
			base.Remove(value);
		}
		...
		/// <param name="value">The value.</param>
		public new void Insert(int index, IContent value)
		{
			if (value is Field)
			{
                if (value is Field f)
