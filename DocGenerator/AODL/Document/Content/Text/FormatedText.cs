...
namespace AODL.Document.Content.Text
{
	...
	public class FormatedText : IHtml, IText, ITextContainer, ICloneable
	{
		...
		public FormatedText(IDocument document, string name, string text)
		{
			...
			Text					= text;
			Style					= (IStyle)new TextStyle(Document, name);
...
// Additional construcor
        ...
        {
          Document				    = document;
          NewXmlNode ( textstyle.StyleName ) ;
          InitStandards();
		...
		{			
			Node		= Document.CreateNode("span", "text");
			XmlAttribute xa = Document.CreateAttribute("style-name", "text");
			xa.Value		= stylename;
