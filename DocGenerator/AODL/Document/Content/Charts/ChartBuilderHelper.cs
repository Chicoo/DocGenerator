...
namespace AODL.Document.Content.Charts
{
	...
	{
        readonly IDocument m_document = null;
		ChartPlotArea ChartPlotArea = null;
		CellRanges m_tableData;
        readonly int startRowIndex = 0;
        readonly int endRowIndex   = 0;
        readonly int startColumnIndex = 0;
        readonly int endColumnIndex   = 0;
		Table table   = null;
		...
		public Table CreateTableFromCellRange()
		{
			...
			else if (ChartPlotArea .FirstLineHasLabels ())
			{
				FirstLineLabels();
			}
