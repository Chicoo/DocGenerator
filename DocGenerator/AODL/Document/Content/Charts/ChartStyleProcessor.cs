...
namespace AODL.Document.Content.Charts
{
	...
	public class ChartStyleProcessor
	{
		...
		public XmlNode ReadStyleNode(string styleName)
		{
			...
			automaticStyleNode                    = Chart.ChartDoc .SelectSingleNode (AutomaticStylePath,Chart .Document .NamespaceManager );
			...
			if (automaticStyleNode!=null)
			{
				...
				{
					XmlNode family                = nodeChild.SelectSingleNode ("@style:family",Chart .Document .NamespaceManager );
				
					if (family!=null&&family.InnerText =="chart")
					{
						XmlNode stylename         = nodeChild.SelectSingleNode ("@style:name",Chart .Document .NamespaceManager);
		...
		{
            AxesStyle axesStyle = new AxesStyle(Chart.Document)
            {
                Node = nodeStyle
            };
            IPropertyCollection  pCollection      = new IPropertyCollection ();
