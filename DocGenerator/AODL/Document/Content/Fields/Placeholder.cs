...
namespace AODL.Document.Content.Fields
{
    ...
    public class Placeholder : Field
    {
        ...
        public PlaceholderType PlaceholderType
        {
            get
            {
                XmlNode xn = _node.SelectSingleNode("@text:placeholder-type",
            ...
            set
            {
                ...
                XmlNode nd = _node.SelectSingleNode("@text:placeholder-type",
                    _document.NamespaceManager);
                if (nd == null)
                    nd = _node.Attributes.Append(_document.CreateAttribute("placeholder-type", "text"));
                nd.InnerText = s;
            }
        }
        ...
        public string Description
        {
            get
            {
                XmlNode xn = _node.SelectSingleNode("@text:description",
                    _document.NamespaceManager);
            ...
            set
            {
                XmlNode nd = _node.SelectSingleNode("@text:description",
                    _document.NamespaceManager);
                if (nd == null)
                    nd = Node.Attributes.Append(_document.CreateAttribute("description", "text"));
                nd.InnerText = value;
            }
        }
