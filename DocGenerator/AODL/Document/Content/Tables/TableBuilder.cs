...
namespace AODL.Document.Content.Tables
{
	...
	public class TableBuilder
	{
		...
		/// <returns></returns>
		public static Table CreateSpreadsheetTable(SpreadsheetDocuments.SpreadsheetDocument document, string tableName, string styleName)
		{
		...
		public static Table CreateTextDocumentTable(
            TextDocuments.TextDocument document, 
			string tableName, 
			string styleName, 
			int rows, 
			int columns, 
