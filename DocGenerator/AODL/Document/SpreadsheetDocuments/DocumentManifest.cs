...
namespace AODL.Document.SpreadsheetDocuments
{
	...
	/// </summary>
	public class DocumentManifest : TextDocuments.DocumentManifest
	{
		/// <summary>
		...
		public override void New()
		{
			...
			Stream str			= ass.GetManifestResourceStream("DocumentGenerator.WordDocuments.AODL.Resources.OD.spreadsheetmanifest.xml");
